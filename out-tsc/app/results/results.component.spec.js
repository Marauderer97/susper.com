...
describe('ResultsComponent', function () {
    ...
    it('should have an app-related-search element', function () {
        var compiled = fixture.debugElement.nativeElement;
        expect(compiled.querySelector('app-related-search')).toBeTruthy();
    });
    it('should have an footer-navbar element', function () {
        var compiled = fixture.debugElement.nativeElement;
        expect(compiled.querySelector('app-footer-navbar')).toBeTruthy();
    });
    it('should have an app-infobox element', function () {
        var compiled = fixture.debugElement.nativeElement;
        expect(compiled.querySelector('app-infobox')).toBeTruthy();
    });
    it('should have an app-theme element', function () {
        var compiled = fixture.debugElement.nativeElement;
        expect(compiled.querySelector('app-theme')).toBeTruthy();
    });
    it('should have a search options menu', function () {
        var compiled = fixture.debugElement.nativeElement;
        expect(compiled.querySelector('div#search-options-field ul#search-options'));
    });
    it('should have "items$" variable', function () {
        expect(component.items$).toBeTruthy();
    });
    it('should have a tool drop-down menu', function () {
        var compiled = fixture.debugElement.nativeElement;
    ...
    it('should have a pagination bar', function () {
        var compiled = fixture.debugElement.nativeElement;
        expect(compiled.querySelector('div.pagination-bar'));
    });
    it('should have correctly related sub-components', function () {
        var compiled = fixture.debugElement.nativeElement;
    ...
    it('should have appropriate message', function () {
        var compiled = fixture.debugElement.nativeElement;
